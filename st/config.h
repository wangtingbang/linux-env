...
static char *font = "Fira Code:size=10:weight=regular:antialias=true:autohint=true";
...
//static char *font = "VictorMono Nerd Font:size=11:weight=semibold:antialias=true:autohint=true";
//static char *font = "Caskaydia Cove Nerd Font:size=11.5:weight=semilight:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
